			...
			<div class="box-body">
				<form id="form-perawatan" method="POST">
					...
					<div class="text-center">
						<button type="button" class="btn btn-flat" onclick="location.href='{{ url('perawatan/index_humas_belum') }}'" >Kembali</button>
...
<script>
	$('#btn-submit').click(function(e) {
		...
		axios.post('{{ url('perawatan/store_perawatan') }}',
			formData
			)
		.then(res => {
			...
			} else
			{
				swal({
					icon : 'success',
					title : 'Berhasil',
					text : 'Berhasil Menambah Perawatan',
					buttons : false,
					closeOnClickOutside : false,
					timer : 1500, 
				})
